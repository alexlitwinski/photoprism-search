...
async def websocket_search(
    ...
    system_instruction = (
        ...
        "- NÃO utilize o prefixo \"place:\". Para cidades, países ou locais, coloque o nome do local diretamente como palavra-chave textual. Envolva em aspas se contiver espaços (ex: \"Miami\", \"Ouro Preto\", \"New York\"). O prefixo \"place:\" causa erro 400 no servidor do usuário.\n"
        ...
        "Se o usuário pedir fotos de uma cidade, localidade, país ou viagem (ex: 'Miami', 'NYC', 'Orlando', 'Brasil'), "
        "NÃO responda dizendo que o local não existe e NÃO use o prefixo 'place:'. Simplesmente gere a busca textual simples por essa palavra no campo 'q' (ex: 'q': 'Miami' ou 'q': '\"New York\"'). "
